...
function sign() {
    ...
    axios.put(`${url}/outcoming-letters/${route.meta.api_letter}/${route.params.id}/approve`, payload).then(res => {
        loading.value.close()
        Swal.fire({
            title: 'Berhasil!',
    ...
    <div class="flex flex-col bg-white rounded-lg">
        <div class="min-w-full inline-block align-middle">
            <div class="flex justify-end px-5 py-5">
                <button class="btn btn-primary" @click="open_modal_approve">Setujui Surat</button>
            </div>
