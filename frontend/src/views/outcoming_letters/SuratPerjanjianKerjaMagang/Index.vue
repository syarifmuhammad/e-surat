...
<template>
    ...
    <!-- <SubHeader :title="`Surat Perjanjian Kerja Magang`">
    ...
    <div class="flex flex-col bg-white rounded-lg">
        <div class="px-8 py-5 min-w-full inline-block align-middle">
            <div class="flex justify-between mb-6">
                <h3 class="text-primary-400">List Surat Perjanjian Kerja Magang</h3>
                <RouterLink v-if="userStore.user.roles === 'superadmin' || userStore.user.roles === 'admin_sdm'" :to="{ name: 'create_surat_perjanjian_kerja_magang' }" class="btn btn-primary">
                    <Icon class="text-lg" icon="fluent:add-12-filled" /> Tambah Surat Perjanjian Kerja Magang
                </RouterLink>
            </div>
            <CustomTable ref="table" :thead="thead" :url="`${url}/outcoming-letters/surat-perjanjian-kerja-magang`" v-slot="item">
                    ...
                    <div class="hs-dropdown relative inline-flex">
                        ...
                        <div class="z-10 hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[15rem] bg-white shadow-md rounded-lg p-2 mt-2 divide-y divide-gray-200"
                            ...
                            <div class="py-2 first:pt-0 last:pb-0">
                                <RouterLink target="_blank" :to="{ name: 'preview_surat_perjanjian_kerja_magang', params: { id: item.id } }"
