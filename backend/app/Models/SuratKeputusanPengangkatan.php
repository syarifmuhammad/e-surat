...
class SuratKeputusanPengangkatan extends Model
{
    // use HasFactory;
    ...
    public function can_signed()
    {
        return !$this->is_signed() && $this->have_reference_number() && auth()->id() == $this->signer_id
            && !(($this->signature_type == 'manual' || $this->signature_type == 'digital'));
    }
    ...
    public function generate_docx()
    {
        ...
        $templateProcessor->setValue('uppercase_pengangkatan_dalam_jabatan', Str::upper($this->pengangkatan_dalam_jabatan));
